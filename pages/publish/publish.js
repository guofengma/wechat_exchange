  ...
  formSubmit(e) {
    ...
    if (this.data.exchage_active) {
      fetch({
        ...
        baseUrl: "http://123.207.144.58:8123/",
        ...
        //上传图片
        wx.uploadFile({
          url: 'http://123.207.144.58:8123/upload', //仅为示例，非真实的接口地址
          filePath: that.data.previewImg1,
           name: 'file',
           formData: {
              'user': 'test'
           },
        ...
        wx.uploadFile({
          url: 'http://123.207.144.58:8123/upload', //仅为示例，非真实的接口地址
          filePath: that.data.previewImg2,
          name: 'file',
          formData: {
            'user': 'test'
          },
        ...
        wx.uploadFile({
          url: 'http://123.207.144.58:8123/upload', //仅为示例，非真实的接口地址
          filePath: that.data.previewImg3,
          name: 'file',
          formData: {
            'user': 'test'
          },
